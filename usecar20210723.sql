...
-- 导出 usecar 的数据库结构
DROP DATABASE IF EXISTS `usecar`;
CREATE DATABASE IF NOT EXISTS `usecar` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `usecar`;

-- 导出  表 usecar.act_evt_log 结构
...
-- 正在导出表  usecar.act_evt_log 的数据：~0 rows (大约)
DELETE FROM `act_evt_log`;
/*!40000 ALTER TABLE `act_evt_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_evt_log` ENABLE KEYS */;

-- 导出  表 usecar.act_ge_bytearray 结构
...
-- 正在导出表  usecar.act_ge_bytearray 的数据：~0 rows (大约)
DELETE FROM `act_ge_bytearray`;
/*!40000 ALTER TABLE `act_ge_bytearray` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_ge_bytearray` ENABLE KEYS */;

-- 导出  表 usecar.act_ge_property 结构
...
-- 正在导出表  usecar.act_ge_property 的数据：~3 rows (大约)
...
-- 正在导出表  usecar.act_hi_actinst 的数据：~0 rows (大约)
DELETE FROM `act_hi_actinst`;
/*!40000 ALTER TABLE `act_hi_actinst` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_hi_actinst` ENABLE KEYS */;

-- 导出  表 usecar.act_hi_attachment 结构
...
-- 正在导出表  usecar.act_hi_attachment 的数据：~0 rows (大约)
DELETE FROM `act_hi_attachment`;
/*!40000 ALTER TABLE `act_hi_attachment` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_hi_attachment` ENABLE KEYS */;

-- 导出  表 usecar.act_hi_comment 结构
...
-- 正在导出表  usecar.act_hi_comment 的数据：~0 rows (大约)
DELETE FROM `act_hi_comment`;
/*!40000 ALTER TABLE `act_hi_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_hi_comment` ENABLE KEYS */;

-- 导出  表 usecar.act_hi_detail 结构
...
-- 正在导出表  usecar.act_hi_detail 的数据：~0 rows (大约)
DELETE FROM `act_hi_detail`;
/*!40000 ALTER TABLE `act_hi_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_hi_detail` ENABLE KEYS */;

-- 导出  表 usecar.act_hi_identitylink 结构
...
-- 正在导出表  usecar.act_hi_identitylink 的数据：~0 rows (大约)
DELETE FROM `act_hi_identitylink`;
/*!40000 ALTER TABLE `act_hi_identitylink` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_hi_identitylink` ENABLE KEYS */;

-- 导出  表 usecar.act_hi_procinst 结构
...
-- 正在导出表  usecar.act_hi_procinst 的数据：~0 rows (大约)
DELETE FROM `act_hi_procinst`;
/*!40000 ALTER TABLE `act_hi_procinst` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_hi_procinst` ENABLE KEYS */;

-- 导出  表 usecar.act_hi_taskinst 结构
...
-- 正在导出表  usecar.act_hi_taskinst 的数据：~0 rows (大约)
DELETE FROM `act_hi_taskinst`;
/*!40000 ALTER TABLE `act_hi_taskinst` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_hi_taskinst` ENABLE KEYS */;

-- 导出  表 usecar.act_hi_varinst 结构
...
-- 正在导出表  usecar.act_hi_varinst 的数据：~0 rows (大约)
DELETE FROM `act_hi_varinst`;
/*!40000 ALTER TABLE `act_hi_varinst` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_hi_varinst` ENABLE KEYS */;

-- 导出  表 usecar.act_id_group 结构
...
-- 正在导出表  usecar.act_id_group 的数据：~0 rows (大约)
DELETE FROM `act_id_group`;
/*!40000 ALTER TABLE `act_id_group` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_id_group` ENABLE KEYS */;

-- 导出  表 usecar.act_id_info 结构
...
-- 正在导出表  usecar.act_id_info 的数据：~0 rows (大约)
DELETE FROM `act_id_info`;
/*!40000 ALTER TABLE `act_id_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_id_info` ENABLE KEYS */;

-- 导出  表 usecar.act_id_membership 结构
...
-- 正在导出表  usecar.act_id_membership 的数据：~0 rows (大约)
DELETE FROM `act_id_membership`;
/*!40000 ALTER TABLE `act_id_membership` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_id_membership` ENABLE KEYS */;

-- 导出  表 usecar.act_id_user 结构
...
-- 正在导出表  usecar.act_id_user 的数据：~0 rows (大约)
DELETE FROM `act_id_user`;
/*!40000 ALTER TABLE `act_id_user` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_id_user` ENABLE KEYS */;

-- 导出  表 usecar.act_procdef_info 结构
...
-- 正在导出表  usecar.act_procdef_info 的数据：~0 rows (大约)
DELETE FROM `act_procdef_info`;
/*!40000 ALTER TABLE `act_procdef_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_procdef_info` ENABLE KEYS */;

-- 导出  表 usecar.act_re_deployment 结构
...
-- 正在导出表  usecar.act_re_deployment 的数据：~0 rows (大约)
DELETE FROM `act_re_deployment`;
/*!40000 ALTER TABLE `act_re_deployment` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_re_deployment` ENABLE KEYS */;

-- 导出  表 usecar.act_re_model 结构
...
-- 正在导出表  usecar.act_re_model 的数据：~0 rows (大约)
DELETE FROM `act_re_model`;
/*!40000 ALTER TABLE `act_re_model` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_re_model` ENABLE KEYS */;

-- 导出  表 usecar.act_re_procdef 结构
...
-- 正在导出表  usecar.act_re_procdef 的数据：~0 rows (大约)
DELETE FROM `act_re_procdef`;
/*!40000 ALTER TABLE `act_re_procdef` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_re_procdef` ENABLE KEYS */;

-- 导出  表 usecar.act_ru_event_subscr 结构
...
-- 正在导出表  usecar.act_ru_event_subscr 的数据：~0 rows (大约)
DELETE FROM `act_ru_event_subscr`;
/*!40000 ALTER TABLE `act_ru_event_subscr` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_ru_event_subscr` ENABLE KEYS */;

-- 导出  表 usecar.act_ru_execution 结构
...
-- 正在导出表  usecar.act_ru_execution 的数据：~0 rows (大约)
DELETE FROM `act_ru_execution`;
/*!40000 ALTER TABLE `act_ru_execution` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_ru_execution` ENABLE KEYS */;

-- 导出  表 usecar.act_ru_identitylink 结构
...
-- 正在导出表  usecar.act_ru_identitylink 的数据：~0 rows (大约)
DELETE FROM `act_ru_identitylink`;
/*!40000 ALTER TABLE `act_ru_identitylink` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_ru_identitylink` ENABLE KEYS */;

-- 导出  表 usecar.act_ru_job 结构
...
-- 正在导出表  usecar.act_ru_job 的数据：~0 rows (大约)
DELETE FROM `act_ru_job`;
/*!40000 ALTER TABLE `act_ru_job` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_ru_job` ENABLE KEYS */;

-- 导出  表 usecar.act_ru_task 结构
...
-- 正在导出表  usecar.act_ru_task 的数据：~0 rows (大约)
DELETE FROM `act_ru_task`;
/*!40000 ALTER TABLE `act_ru_task` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_ru_task` ENABLE KEYS */;

-- 导出  表 usecar.act_ru_variable 结构
...
-- 正在导出表  usecar.act_ru_variable 的数据：~0 rows (大约)
DELETE FROM `act_ru_variable`;
/*!40000 ALTER TABLE `act_ru_variable` DISABLE KEYS */;
/*!40000 ALTER TABLE `act_ru_variable` ENABLE KEYS */;

-- 导出  表 usecar.app_member 结构
...
-- 正在导出表  usecar.app_member 的数据：~3 rows (大约)
...
-- 导出  表 usecar.qrtz_blob_triggers 结构
...
-- 正在导出表  usecar.qrtz_blob_triggers 的数据：~0 rows (大约)
DELETE FROM `qrtz_blob_triggers`;
/*!40000 ALTER TABLE `qrtz_blob_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_blob_triggers` ENABLE KEYS */;

-- 导出  表 usecar.qrtz_calendars 结构
...
-- 正在导出表  usecar.qrtz_calendars 的数据：~0 rows (大约)
DELETE FROM `qrtz_calendars`;
/*!40000 ALTER TABLE `qrtz_calendars` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_calendars` ENABLE KEYS */;

-- 导出  表 usecar.qrtz_cron_triggers 结构
...
-- 正在导出表  usecar.qrtz_cron_triggers 的数据：~0 rows (大约)
DELETE FROM `qrtz_cron_triggers`;
/*!40000 ALTER TABLE `qrtz_cron_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_cron_triggers` ENABLE KEYS */;

-- 导出  表 usecar.qrtz_fired_triggers 结构
...
-- 正在导出表  usecar.qrtz_fired_triggers 的数据：~0 rows (大约)
DELETE FROM `qrtz_fired_triggers`;
/*!40000 ALTER TABLE `qrtz_fired_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_fired_triggers` ENABLE KEYS */;

-- 导出  表 usecar.qrtz_job_details 结构
...
-- 正在导出表  usecar.qrtz_job_details 的数据：~0 rows (大约)
DELETE FROM `qrtz_job_details`;
/*!40000 ALTER TABLE `qrtz_job_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_job_details` ENABLE KEYS */;

-- 导出  表 usecar.qrtz_locks 结构
...
-- 正在导出表  usecar.qrtz_locks 的数据：~0 rows (大约)
...
-- 导出  表 usecar.qrtz_paused_trigger_grps 结构
...
-- 正在导出表  usecar.qrtz_paused_trigger_grps 的数据：~0 rows (大约)
DELETE FROM `qrtz_paused_trigger_grps`;
/*!40000 ALTER TABLE `qrtz_paused_trigger_grps` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_paused_trigger_grps` ENABLE KEYS */;

-- 导出  表 usecar.qrtz_scheduler_state 结构
...
-- 正在导出表  usecar.qrtz_scheduler_state 的数据：~0 rows (大约)
DELETE FROM `qrtz_scheduler_state`;
/*!40000 ALTER TABLE `qrtz_scheduler_state` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_scheduler_state` ENABLE KEYS */;

-- 导出  表 usecar.qrtz_simple_triggers 结构
...
-- 正在导出表  usecar.qrtz_simple_triggers 的数据：~0 rows (大约)
DELETE FROM `qrtz_simple_triggers`;
/*!40000 ALTER TABLE `qrtz_simple_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_simple_triggers` ENABLE KEYS */;

-- 导出  表 usecar.qrtz_simprop_triggers 结构
...
-- 正在导出表  usecar.qrtz_simprop_triggers 的数据：~0 rows (大约)
DELETE FROM `qrtz_simprop_triggers`;
/*!40000 ALTER TABLE `qrtz_simprop_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_simprop_triggers` ENABLE KEYS */;

-- 导出  表 usecar.qrtz_triggers 结构
...
-- 正在导出表  usecar.qrtz_triggers 的数据：~0 rows (大约)
DELETE FROM `qrtz_triggers`;
/*!40000 ALTER TABLE `qrtz_triggers` DISABLE KEYS */;
/*!40000 ALTER TABLE `qrtz_triggers` ENABLE KEYS */;

-- 导出  表 usecar.t_act_business 结构
...
-- 正在导出表  usecar.t_audit 的数据：~2 rows (大约)
DELETE FROM `t_audit`;
/*!40000 ALTER TABLE `t_audit` DISABLE KEYS */;
INSERT INTO `t_audit` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `car`, `car_owner`, `ccdd`, `image`, `jcr`, `jssj`, `kssj`, `mdd`, `reason`, `shr`, `ycbm`, `sqr`, `shrr`, `status`, `audit_msg`) VALUES
	('1418386013335719936', NULL, '2021-07-23 09:42:32.594000', 0, NULL, '2021-07-23 09:51:22.398000', '浙A123456', '张三', '东华门街道锡拉胡同淘汇新天(北京市东城区东华门街道锡拉胡同淘汇新天) 纬度:39.916295经度:116.410344', '543927ed065ee04d040975d05b832f15edbd.png', '李四', '2021-07-23 09:42', '2021-07-23 09:42', '黑芝麻爆珠饮(北京市东城区王府井大街219-1号) 纬度:39.916302经度:116.410961', '我要用车', NULL, '40322777781112832', '管理员', 'undefined', 1, NULL),
	('1418444455538724865', NULL, '2021-07-23 13:34:46.303000', 0, NULL, '2021-07-23 13:34:56.615000', '浙江b312546', '郑为中', '', '02a0b69a0aee504f780893b0ed3d6e4864f5.png', '郑为中', '2021-07-26 13:34', '2021-07-23 18:33', '', '我要用车', NULL, '40322777781112832', '管理员', '682265633886208', 2, NULL);
/*!40000 ALTER TABLE `t_audit` ENABLE KEYS */;

-- 导出  表 usecar.t_auto_chat 结构
...
-- 正在导出表  usecar.t_car_archives 的数据：~3 rows (大约)
DELETE FROM `t_car_archives`;
/*!40000 ALTER TABLE `t_car_archives` DISABLE KEYS */;
INSERT INTO `t_car_archives` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `driving_license`, `license`, `remark`, `title`, `user_name`, `label`, `value`) VALUES
	('1413102190175850496', 'admin', '2021-07-08 19:46:31.005000', 0, NULL, NULL, '512121212', '浙A-000000', '测试', '私人车辆A', '人事员工A', '私人车辆A', '私人车辆A'),
	('1413102320337686529', 'admin', '2021-07-08 19:47:02.020000', 0, NULL, NULL, '455555454', '浙B-000000', '测试', '私人车辆2', '人事员工B', '私人车辆2', '私人车辆2'),
	('1413103588556804097', 'admin', '2021-07-08 19:52:04.390000', 0, NULL, NULL, '2442424242', '浙C-000000', '测试', '私人车辆3', '人事经理', '私人车辆3', '私人车辆3');
/*!40000 ALTER TABLE `t_car_archives` ENABLE KEYS */;

-- 导出  表 usecar.t_client 结构
...
-- 正在导出表  usecar.t_department 的数据：~11 rows (大约)
...
INSERT INTO `t_department` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `parent_id`, `sort_order`, `status`, `title`, `is_parent`) VALUES
	(40322777781112832, '', '2018-08-10 20:40:40', 0, 'admin', '2021-07-08 19:21:02', 0, 1.00, 0, '人事部', b'0'),
	(1413095798912192513, 'admin', '2021-07-08 19:21:07', 0, 'admin', '2021-07-08 19:21:07', 0, 2.00, 0, '财务部', b'0'),
	(1413095841186582529, 'admin', '2021-07-08 19:21:17', 0, 'admin', '2021-07-08 19:21:17', 0, 3.00, 0, '行政部', b'0'),
	(1413095857837969409, 'admin', '2021-07-08 19:21:21', 0, 'admin', '2021-07-08 19:21:21', 0, 4.00, 0, '开发部', b'0'),
	(1413097160513294337, 'admin', '2021-07-08 19:26:32', 0, 'admin', '2021-07-08 19:26:32', 0, 5.00, 0, '总经办', b'0');
/*!40000 ALTER TABLE `t_department` ENABLE KEYS */;

-- 导出  表 usecar.t_department_header 结构
...
-- 正在导出表  usecar.t_department_header 的数据：~8 rows (大约)
...
INSERT INTO `t_department_header` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `department_id`, `type`, `user_id`) VALUES
	(1414126510717145088, 'admin', '2021-07-11 15:36:48', 0, 'admin', '2021-07-11 15:36:48', 40322777781112832, 0, 1413102530837221377),
	(1414126510717145089, 'admin', '2021-07-11 15:36:48', 0, 'admin', '2021-07-11 15:36:48', 40322777781112832, 0, 682265633886208),
	(1414126535484510208, 'admin', '2021-07-11 15:36:54', 0, 'admin', '2021-07-11 15:36:54', 1413095798912192513, 0, 1413102624856739841),
	(1414126535484510209, 'admin', '2021-07-11 15:36:54', 0, 'admin', '2021-07-11 15:36:54', 1413095798912192513, 0, 682265633886208),
	(1414126559211687936, 'admin', '2021-07-11 15:37:00', 0, 'admin', '2021-07-11 15:37:00', 1413095841186582529, 0, 1413103099253493761),
	(1414126559211687937, 'admin', '2021-07-11 15:37:00', 0, 'admin', '2021-07-11 15:37:00', 1413095841186582529, 0, 682265633886208),
	(1414126580455837696, 'admin', '2021-07-11 15:37:05', 0, 'admin', '2021-07-11 15:37:05', 1413095857837969409, 0, 1413103226995216384),
	(1414126580455837697, 'admin', '2021-07-11 15:37:05', 0, 'admin', '2021-07-11 15:37:05', 1413095857837969409, 0, 682265633886208),
	(1414126597300162560, 'admin', '2021-07-11 15:37:09', 0, 'admin', '2021-07-11 15:37:09', 1413097160513294337, 0, 1413097124354199552),
	(1414126597300162561, 'admin', '2021-07-11 15:37:09', 0, 'admin', '2021-07-11 15:37:09', 1413097160513294337, 0, 682265633886208);
/*!40000 ALTER TABLE `t_department_header` ENABLE KEYS */;

-- 导出  表 usecar.t_dict 结构
...
-- 正在导出表  usecar.t_dict 的数据：~9 rows (大约)
DELETE FROM `t_dict`;
...
-- 正在导出表  usecar.t_dict_data 的数据：~55 rows (大约)
...
-- 正在导出表  usecar.t_file 的数据：~0 rows (大约)
DELETE FROM `t_file`;
/*!40000 ALTER TABLE `t_file` DISABLE KEYS */;
/*!40000 ALTER TABLE `t_file` ENABLE KEYS */;

-- 导出  表 usecar.t_leave 结构
...
-- 正在导出表  usecar.t_log 的数据：~14 rows (大约)
DELETE FROM `t_log`;
...
INSERT INTO `t_log` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `cost_time`, `ip`, `ip_info`, `name`, `request_param`, `request_type`, `request_url`, `username`, `log_type`, `device`) VALUES
	...
	(1412228925144305664, NULL, '2021-07-06 09:56:29', 0, NULL, '2021-07-06 09:56:29', 215, '127.0.0.1', '未知', '登录系统', '{"password":"你是看不见我的","code":"x2uy","saveLogin":"true","captchaId":"d34c44bde54d4ff1a57927f479a79ea5","username":"admin"}', 'POST', '/xboot/login', 'admin', 1, 'Chrome 91.0.4472.114 | Windows Windows 10 or Windows Server 2016 | PC端'),
	(1412228967930400768, NULL, '2021-07-06 09:56:39', 0, NULL, '2021-07-06 09:56:39', 66, '127.0.0.1', '未知', '登录系统', '{"password":"你是看不见我的","code":"wpco","saveLogin":"true","captchaId":"f6f96573b0884ccf9a17f7089e6f0d47","username":"admin"}', 'POST', '/xboot/login', 'admin', 1, 'Chrome 91.0.4472.114 | Windows Windows 10 or Windows Server 2016 | PC端'),
	(1413095346703306752, NULL, '2021-07-08 19:19:20', 0, NULL, '2021-07-08 19:19:20', 258, '127.0.0.1', '未知', '登录系统', '{"password":"你是看不见我的","code":"JEF3","saveLogin":"true","captchaId":"2c6ae9349c8f4b519556d6d30d6841ba","username":"admin"}', 'POST', '/xboot/login', 'admin', 1, 'Chrome 91.0.4472.114 | Windows Windows 10 or Windows Server 2016 | PC端'),
	(1413100317939208192, NULL, '2021-07-08 19:39:05', 0, NULL, '2021-07-08 19:39:05', 193, '127.0.0.1', '未知', '登录系统', '{"password":"你是看不见我的","code":"1hj1","saveLogin":"true","captchaId":"e0f71458c1324876b4360e81e24f8451","username":"admin"}', 'POST', '/xboot/login', 'admin', 1, 'Chrome 91.0.4472.114 | Windows Windows 10 or Windows Server 2016 | PC端'),
	(1414090527124623360, NULL, '2021-07-11 13:13:49', 0, NULL, '2021-07-11 13:13:49', 233, '127.0.0.1', '未知', '登录系统', '{"password":"你是看不见我的","code":"soxa","saveLogin":"true","captchaId":"f9cded68965543a2bbcd8437385f061b","username":"admin"}', 'POST', '/xboot/login', 'admin', 1, 'Chrome 91.0.4472.114 | Windows Windows 10 or Windows Server 2016 | PC端'),
	(1414090623903993856, NULL, '2021-07-11 13:14:12', 0, NULL, '2021-07-11 13:14:12', 57, '127.0.0.1', '未知', '登录系统', '{"password":"你是看不见我的","code":"chwt","saveLogin":"true","captchaId":"0da288cc38a94725ab88176d6260ab61","username":"admin"}', 'POST', '/xboot/login', 'admin', 1, 'Chrome 91.0.4472.114 | Windows Windows 10 or Windows Server 2016 | PC端'),
	(1414126441074921472, NULL, '2021-07-11 15:36:32', 0, NULL, '2021-07-11 15:36:32', 84, '127.0.0.1', '未知', '登录系统', '{"password":"你是看不见我的","code":"2xat","saveLogin":"true","captchaId":"79fb444c590b4d61a3be0b6146295e4a","username":"admin"}', 'POST', '/xboot/login', 'admin', 1, 'Chrome 91.0.4472.114 | Windows Windows 10 or Windows Server 2016 | PC端'),
	(1417778599313936384, NULL, '2021-07-21 17:28:54', 0, NULL, '2021-07-21 17:28:54', 229, '127.0.0.1', '未知', '登录系统', '{"password":"你是看不见我的","code":"BJMO","saveLogin":"true","captchaId":"b46952f55b9d42dca28abff38dc00a9b","username":"admin"}', 'POST', '/xboot/login', 'admin', 1, 'Chrome 91.0.4472.164 | Windows Windows 10 or Windows Server 2016 | PC端'),
	(1418389779606802432, NULL, '2021-07-23 09:57:31', 0, NULL, '2021-07-23 09:57:31', 287, '127.0.0.1', '未知', '登录系统', '{"password":"你是看不见我的","code":"QKO9","saveLogin":"true","captchaId":"4a047bf5c1584abd88a0b187f56f38a4","username":"admin"}', 'POST', '/xboot/login', 'admin', 1, 'Chrome 91.0.4472.164 | Windows Windows 10 or Windows Server 2016 | PC端');
/*!40000 ALTER TABLE `t_log` ENABLE KEYS */;

-- 导出  表 usecar.t_message 结构
...
-- 正在导出表  usecar.t_message 的数据：~5 rows (大约)
...
-- 正在导出表  usecar.t_message_send 的数据：~0 rows (大约)
DELETE FROM `t_message_send`;
/*!40000 ALTER TABLE `t_message_send` DISABLE KEYS */;
INSERT INTO `t_message_send` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `message_id`, `status`, `user_id`, `params`) VALUES
	(1413096142236946432, NULL, '2021-07-08 19:22:29', 0, NULL, '2021-07-08 19:22:29', 43615268366192640, 0, 1413096141318393856, NULL),
	(1413096252542947328, NULL, '2021-07-08 19:22:55', 0, NULL, '2021-07-08 19:22:55', 43615268366192640, 0, 1413096251808944129, NULL),
	(1413096364195319808, NULL, '2021-07-08 19:23:22', 0, NULL, '2021-07-08 19:23:22', 43615268366192640, 0, 1413096363511648257, NULL),
	(1413096458684600320, NULL, '2021-07-08 19:23:44', 0, NULL, '2021-07-08 19:23:44', 43615268366192640, 0, 1413096457996734465, NULL),
	(1413096586124333056, NULL, '2021-07-08 19:24:15', 0, NULL, '2021-07-08 19:24:15', 43615268366192640, 0, 1413096585432272897, NULL),
	(1413096679397265408, NULL, '2021-07-08 19:24:37', 0, NULL, '2021-07-08 19:24:37', 43615268366192640, 0, 1413096678713593857, NULL),
	(1413096855092465664, NULL, '2021-07-08 19:25:19', 0, NULL, '2021-07-08 19:25:19', 43615268366192640, 0, 1413096854404599809, NULL),
	(1413096965335552000, NULL, '2021-07-08 19:25:45', 0, NULL, '2021-07-08 19:25:45', 43615268366192640, 0, 1413096964601548801, NULL),
	(1413097125088202752, NULL, '2021-07-08 19:26:23', 0, NULL, '2021-07-08 19:26:23', 43615268366192640, 0, 1413097124354199552, NULL),
	(1413102531785134080, NULL, '2021-07-08 19:47:52', 0, NULL, '2021-07-08 19:47:52', 43615268366192640, 0, 1413102530837221377, NULL),
	(1413102625724960768, NULL, '2021-07-08 19:48:15', 0, NULL, '2021-07-08 19:48:15', 43615268366192640, 0, 1413102624856739841, NULL),
	(1413103100092354560, NULL, '2021-07-08 19:50:08', 0, NULL, '2021-07-08 19:50:08', 43615268366192640, 0, 1413103099253493761, NULL),
	(1413103227796328448, NULL, '2021-07-08 19:50:38', 0, NULL, '2021-07-08 19:50:38', 43615268366192640, 0, 1413103226995216384, NULL);
/*!40000 ALTER TABLE `t_message_send` ENABLE KEYS */;

-- 导出  表 usecar.t_permission 结构
...
-- 正在导出表  usecar.t_permission 的数据：~44 rows (大约)
...
INSERT INTO `t_permission` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `description`, `name`, `parent_id`, `type`, `sort_order`, `component`, `path`, `title`, `icon`, `level`, `button_type`, `status`, `url`, `show_always`, `is_menu`, `is_parent`) VALUES
	...
	(1413099752731578368, 'admin', '2021-07-08 19:36:50', 0, 'admin', '2021-07-08 19:36:50', NULL, 'oneVueTable', 5129710648430592, 0, 8.00, 'asBase/oneJavaVue/tableGenerator', 'oneVueTable', 'Vue表格', 'ios-tablet-landscape', 2, '', 0, NULL, b'1', b'1', b'0'),
	(1413101516218306561, 'admin', '2021-07-08 19:43:50', 0, 'admin', '2021-07-23 10:01:00', '', 'carArchives', 0, -1, 2.00, '', '', '私车公用', 'ios-american-football', 0, '', 0, '', b'1', b'1', b'1'),
	(1413101564209532929, 'admin', '2021-07-08 19:44:02', 0, 'admin', '2021-07-08 19:44:32', '', 'carArchives1', 1413101516218306561, 0, 1.00, 'Main', '/carArchives1', '车辆档案', 'md-albums', 1, '', 0, '', b'1', b'1', b'1'),
	(1413101692848836609, 'admin', '2021-07-08 19:44:32', 0, 'admin', '2021-07-08 19:44:32', NULL, 'carArchives2', 1413101564209532929, 0, 1.00, 'zwz/car/index', 'carArchives2', '车辆档案', 'ios-aperture', 2, '', 0, NULL, b'1', b'1', b'0'),
	(1418390764995612672, 'admin', '2021-07-23 10:01:26', 0, 'admin', '2021-07-23 10:01:53', NULL, 'carArchives2', 1413101516218306561, 0, 2.00, 'Main', '/carArchives2', '用车审核', 'md-aperture', 1, '', 0, NULL, b'1', b'1', b'1'),
	(1418390881861505024, 'admin', '2021-07-23 10:01:53', 0, 'admin', '2021-07-23 10:01:53', NULL, 'carAudit', 1418390764995612672, 0, 1.00, 'zwz/audit/index', 'carAudit', '用车统计', 'ios-apps', 2, '', 0, NULL, b'1', b'1', b'0');
/*!40000 ALTER TABLE `t_permission` ENABLE KEYS */;

-- 导出  表 usecar.t_quartz_job 结构
...
-- 正在导出表  usecar.t_role 的数据：~2 rows (大约)
DELETE FROM `t_role`;
...
INSERT INTO `t_role` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `name`, `del_flag`, `default_role`, `description`, `data_type`) VALUES
	(496138616573952, '', '2018-04-22 23:03:49', 'admin', '2021-07-08 19:48:46', 'ROLE_ADMIN', 0, NULL, '总经理', 0),
	(496138616573953, '', '2018-05-02 21:40:03', 'admin', '2021-07-08 19:48:37', 'ROLE_USER', 0, b'1', '普通员工', 0),
	(1413102813927575553, 'admin', '2021-07-08 19:49:02', 'admin', '2021-07-08 19:49:02', 'ROLE_JL', 0, NULL, '经理', 0);
/*!40000 ALTER TABLE `t_role` ENABLE KEYS */;

-- 导出  表 usecar.t_role_department 结构
...
-- 正在导出表  usecar.t_role_department 的数据：~0 rows (大约)
...
-- 导出  表 usecar.t_role_permission 结构
...
-- 正在导出表  usecar.t_role_permission 的数据：~98 rows (大约)
...
INSERT INTO `t_role_permission` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `permission_id`, `role_id`) VALUES
	(1413102881560727552, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 125909152017944576, 1413102813927575553),
	(1413102881560727553, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 5129710648430592, 1413102813927575553),
	(1413102881560727554, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 5129710648430593, 1413102813927575553),
	(1413102881560727555, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 15701400130424832, 1413102813927575553),
	(1413102881560727556, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16678126574637056, 1413102813927575553),
	(1413102881560727557, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 15701915807518720, 1413102813927575553),
	(1413102881560727558, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 15708892205944832, 1413102813927575553),
	(1413102881560727559, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16678447719911424, 1413102813927575553),
	(1413102881560727560, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 25014528525733888, 1413102813927575553),
	(1413102881560727561, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 56898976661639168, 1413102813927575553),
	(1413102881560727562, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 156365156580855808, 1413102813927575553),
	(1413102881560727563, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 40238597734928384, 1413102813927575553),
	(1413102881560727564, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 45235621697949696, 1413102813927575553),
	(1413102881560727565, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 45235787867885568, 1413102813927575553),
	(1413102881560727566, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 45235939278065664, 1413102813927575553),
	(1413102881560727567, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 56309618086776832, 1413102813927575553),
	(1413102881560727568, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 57212882168844288, 1413102813927575553),
	(1413102881560727569, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 61560041605435392, 1413102813927575553),
	(1413102881560727570, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 61560275261722624, 1413102813927575553),
	(1413102881560727571, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 61560480518377472, 1413102813927575553),
	(1413102881560727572, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 5129710648430594, 1413102813927575553),
	(1413102881560727573, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16687383932047360, 1413102813927575553),
	(1413102881560727574, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16689632049631232, 1413102813927575553),
	(1413102881560727575, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16689745006432256, 1413102813927575553),
	(1413102881560727576, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16689883993083904, 1413102813927575553),
	(1413102881560727577, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16690313745666048, 1413102813927575553),
	(1413102881560727578, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 5129710648430595, 1413102813927575553),
	(1413102881560727579, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16694861252005888, 1413102813927575553),
	(1413102881560727580, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16695107491205120, 1413102813927575553),
	(1413102881560727581, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 16695243126607872, 1413102813927575553),
	(1413102881560727582, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 75002207560273920, 1413102813927575553),
	(1413102881560727583, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 76215889006956544, 1413102813927575553),
	(1413102881560727584, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 76216071333351424, 1413102813927575553),
	(1413102881560727585, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 76216264070008832, 1413102813927575553),
	(1413102881560727586, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 76216459709124608, 1413102813927575553),
	(1413102881560727587, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 76216594207870976, 1413102813927575553),
	(1413102881560727588, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 76216702639017984, 1413102813927575553),
	(1413102881560727589, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 58480609315524608, 1413102813927575553),
	(1413102881560727590, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 61394706252173312, 1413102813927575553),
	(1413102881560727591, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 61417744146370560, 1413102813927575553),
	(1413102881560727592, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 1413099752731578368, 1413102813927575553),
	(1413102881560727593, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 39915540965232640, 1413102813927575553),
	(1413102881560727594, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 41363147411427328, 1413102813927575553),
	(1413102881560727595, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 41363537456533504, 1413102813927575553),
	(1413102881560727596, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 41364927394353152, 1413102813927575553),
	(1413102881560727597, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 1413101516218306561, 1413102813927575553),
	(1413102881560727598, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 1413101564209532929, 1413102813927575553),
	(1413102881560727599, 'admin', '2021-07-08 19:49:16', 0, 'admin', '2021-07-08 19:49:16', 1413101692848836609, 1413102813927575553),
	(1418390920067420160, 'admin', '2021-07-23 10:02:02', 0, 'admin', '2021-07-23 10:02:02', 125909152017944576, 496138616573952),
	(1418390920067420161, 'admin', '2021-07-23 10:02:02', 0, 'admin', '2021-07-23 10:02:02', 5129710648430592, 496138616573952),
	(1418390920067420162, 'admin', '2021-07-23 10:02:02', 0, 'admin', '2021-07-23 10:02:02', 5129710648430593, 496138616573952),
	(1418390920067420163, 'admin', '2021-07-23 10:02:02', 0, 'admin', '2021-07-23 10:02:02', 15701400130424832, 496138616573952),
	(1418390920067420164, 'admin', '2021-07-23 10:02:02', 0, 'admin', '2021-07-23 10:02:02', 16678126574637056, 496138616573952),
	(1418390920067420165, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 15701915807518720, 496138616573952),
	(1418390920067420166, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 15708892205944832, 496138616573952),
	(1418390920067420167, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 16678447719911424, 496138616573952),
	(1418390920067420168, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 25014528525733888, 496138616573952),
	(1418390920067420169, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 56898976661639168, 496138616573952),
	(1418390920067420170, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 156365156580855808, 496138616573952),
	(1418390920067420171, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 40238597734928384, 496138616573952),
	(1418390920067420172, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 45235621697949696, 496138616573952),
	(1418390920067420173, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 45235787867885568, 496138616573952),
	(1418390920067420174, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 45235939278065664, 496138616573952),
	(1418390920067420175, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 56309618086776832, 496138616573952),
	(1418390920067420176, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 57212882168844288, 496138616573952),
	(1418390920067420177, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 61560041605435392, 496138616573952),
	(1418390920067420178, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 61560275261722624, 496138616573952),
	(1418390920067420179, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 61560480518377472, 496138616573952),
	(1418390920067420180, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 5129710648430594, 496138616573952),
	(1418390920067420181, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 16687383932047360, 496138616573952),
	(1418390920067420182, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 16689632049631232, 496138616573952),
	(1418390920067420183, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 16689745006432256, 496138616573952),
	(1418390920067420184, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 16689883993083904, 496138616573952),
	(1418390920067420185, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 16690313745666048, 496138616573952),
	(1418390920067420186, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 5129710648430595, 496138616573952),
	(1418390920067420187, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 16694861252005888, 496138616573952),
	(1418390920067420188, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 16695107491205120, 496138616573952),
	(1418390920067420189, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 16695243126607872, 496138616573952),
	(1418390920067420190, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 75002207560273920, 496138616573952),
	(1418390920067420191, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 76215889006956544, 496138616573952),
	(1418390920067420192, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 76216071333351424, 496138616573952),
	(1418390920067420193, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 76216264070008832, 496138616573952),
	(1418390920067420194, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 76216459709124608, 496138616573952),
	(1418390920067420195, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 76216594207870976, 496138616573952),
	(1418390920067420196, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 76216702639017984, 496138616573952),
	(1418390920067420197, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 58480609315524608, 496138616573952),
	(1418390920067420198, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 61394706252173312, 496138616573952),
	(1418390920067420199, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 61417744146370560, 496138616573952),
	(1418390920067420200, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 1413099752731578368, 496138616573952),
	(1418390920067420201, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 39915540965232640, 496138616573952),
	(1418390920067420202, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 41363147411427328, 496138616573952),
	(1418390920067420203, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 41363537456533504, 496138616573952),
	(1418390920067420204, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 41364927394353152, 496138616573952),
	(1418390920067420205, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 1413101516218306561, 496138616573952),
	(1418390920067420206, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 1413101564209532929, 496138616573952),
	(1418390920067420207, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 1413101692848836609, 496138616573952),
	(1418390920067420208, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 1418390764995612672, 496138616573952),
	(1418390920067420209, 'admin', '2021-07-23 10:02:03', 0, 'admin', '2021-07-23 10:02:03', 1418390881861505024, 496138616573952);
/*!40000 ALTER TABLE `t_role_permission` ENABLE KEYS */;

-- 导出  表 usecar.t_setting 结构
...
-- 正在导出表  usecar.t_setting 的数据：~3 rows (大约)
...
-- 正在导出表  usecar.t_user 的数据：~0 rows (大约)
DELETE FROM `t_user`;
...
INSERT INTO `t_user` (`id`, `create_by`, `create_time`, `update_by`, `update_time`, `address`, `avatar`, `description`, `email`, `mobile`, `nickname`, `password`, `sex`, `status`, `type`, `username`, `del_flag`, `department_id`, `street`, `pass_strength`, `department_title`, `birth`) VALUES
	...
	(1413096141318393856, 'admin', '2021-07-08 19:22:29', 'admin', '2021-07-08 19:22:29', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'rs01@qq.com', '17857054123', '人事员工01', '$2a$10$0nP7ExKkOKLAkmJoI.ra6ep3I2PiZhqEx4enyfFwO5Ug/8/hIMiQu', '男', 0, 0, 'rs01', 0, 40322777781112832, NULL, '弱', '人事部', NULL),
	(1413096251808944129, 'admin', '2021-07-08 19:22:55', 'admin', '2021-07-08 19:22:55', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'rs02@qq.com', '13646667981', '人事员工02', '$2a$10$tg9R903OEl2jykovMvNftOviJf6JFaBWht0Ujl0I5Gm44m.9qcjhy', '女', 0, 0, 'rs02', 0, 40322777781112832, NULL, '弱', '人事部', NULL),
	(1413096363511648257, 'admin', '2021-07-08 19:23:22', 'admin', '2021-07-08 19:23:22', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'cw01@qq.com', '17857946454', '财务员工01', '$2a$10$KA2k9iy2RkEzuMK4.Qir/uTCRz6E2YKBpPkfEbdyCONo8Uzxu9Yfm', '男', 0, 0, 'cw01', 0, 1413095798912192513, NULL, '弱', '财务部', NULL),
	(1413096457996734465, 'admin', '2021-07-08 19:23:44', 'admin', '2021-07-08 19:23:44', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'cw02@qq.com', '17856321485', '财务员工02', '$2a$10$Ye/URnOObnbyCv4HOuu0Ge3acovDexe.wNDtFrOK9sm98q/2MaGi2', '女', 0, 0, 'cw02', 0, 1413095798912192513, NULL, '弱', '财务部', NULL),
	(1413096585432272897, 'admin', '2021-07-08 19:24:15', 'admin', '2021-07-08 19:24:15', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'xz01@qq.com', '17854965423', '行政员工01', '$2a$10$GNLMfD6a.AHfcOlFv86E9eBfUI9fdEDJ2YTU48p2CvD1u.UQ8OgNS', '男', 0, 0, 'xz01', 0, 1413095841186582529, NULL, '弱', '行政部', NULL),
	(1413096678713593857, 'admin', '2021-07-08 19:24:37', 'admin', '2021-07-08 19:24:37', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'xz02@qq.com', '17859654125', '行政员工02', '$2a$10$D8ris1ohpFStfWS5MdktqeOYwW9wO9uYiKDNNq75LvREbJhS1tZwe', '女', 0, 0, 'xz02', 0, 1413095841186582529, NULL, '弱', '行政部', NULL),
	(1413096854404599809, 'admin', '2021-07-08 19:25:19', 'admin', '2021-07-08 19:25:19', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'kf01@qq.com', '17859635412', '开发员工01', '$2a$10$l1G6/GVXKxxtegykC6so0e5oL7ipg6qlw66IwStorOrz/ZBC.Z2a6', '男', 0, 0, 'kf01', 0, 1413095857837969409, NULL, '弱', '开发部', NULL),
	(1413096964601548801, 'admin', '2021-07-08 19:25:45', 'admin', '2021-07-08 19:25:45', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'kf02@qq.com', '17859641785', '开发员工02', '$2a$10$zZYkD1tYKFWwSw6nrzI0zeMvQCorcrIQlLxl3deTtQNPcbsqzgH0W', '女', 0, 0, 'kf02', 0, 1413095857837969409, NULL, '弱', '开发部', NULL),
	(1413097124354199552, 'admin', '2021-07-08 19:26:23', 'admin', '2021-07-08 19:26:50', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', '', 'boss@qq.com', '17859745841', '总经理', '$2a$10$OS3Nl2w/ZtXBWAruNRgAk.TUM2E6pOO0kLNAcScAnCzrqHnAJCk8e', '男', 0, 1, 'boss', 0, 1413097160513294337, '', '弱', '总经办', NULL),
	(1413102530837221377, 'admin', '2021-07-08 19:47:52', 'admin', '2021-07-08 19:49:33', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', '', 'rsjl@qq.com', '17859674139', '人事经理', '$2a$10$AKtdIsjVb85XkJvariSLhOATab.OJXzWywl7D9wbraxW5Y3D5CFj.', '男', 0, 0, 'rsjl', 0, 40322777781112832, '', '弱', '人事部', NULL),
	(1413102624856739841, 'admin', '2021-07-08 19:48:15', 'admin', '2021-07-08 19:49:40', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', '', 'cwjl@qq.com', '13678974357', '财务经理', '$2a$10$4oO9qlCpDpryOrkju7Sfq.sp1zdo15pYKyvPVl/x1kJQWq6EO3Mlq', '女', 0, 0, 'cwjl', 0, 1413095798912192513, '', '弱', '财务部', NULL),
	(1413103099253493761, 'admin', '2021-07-08 19:50:08', 'admin', '2021-07-08 19:50:08', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'xzjl@qq.com', '17859675421', '行政经理', '$2a$10$6C5fv.1QWn9x6I9tqYIdlus5TjxluOzBOJjRwshRm2dloDhi0GUOq', '女', 0, 0, 'xzjl', 0, 1413095841186582529, NULL, '弱', '行政部', NULL),
	(1413103226995216384, 'admin', '2021-07-08 19:50:38', 'admin', '2021-07-08 19:50:38', '', 'https://ooo.0o0.ooo/2019/04/28/5cc5a71a6e3b6.png', NULL, 'kfjl@qq.com', '17859657416', '开发经理', '$2a$10$t7Gy.TMvRM3JPctznxkIBuSWoOEM2F/d5NZhVYNMTkr46596JPT2m', '男', 0, 0, 'kfjl', 0, 1413095857837969409, NULL, '弱', '开发部', NULL);
/*!40000 ALTER TABLE `t_user` ENABLE KEYS */;

-- 导出  表 usecar.t_user_role 结构
...
-- 正在导出表  usecar.t_user_role 的数据：~0 rows (大约)
...
INSERT INTO `t_user_role` (`id`, `create_by`, `create_time`, `del_flag`, `update_by`, `update_time`, `role_id`, `user_id`) VALUES
	...
	(1413097235079630848, 'admin', '2021-07-08 19:26:50', 0, 'admin', '2021-07-08 19:26:50', 496138616573952, 1413097124354199552),
	(1413102954029912064, 'admin', '2021-07-08 19:49:33', 0, 'admin', '2021-07-08 19:49:33', 1413102813927575553, 1413102530837221377),
	(1413102983603949568, 'admin', '2021-07-08 19:49:40', 0, 'admin', '2021-07-08 19:49:40', 1413102813927575553, 1413102624856739841),
	(1413103099882639360, 'admin', '2021-07-08 19:50:08', 0, 'admin', '2021-07-08 19:50:08', 1413102813927575553, 1413103099253493761),
	(1413103227553058817, 'admin', '2021-07-08 19:50:38', 0, 'admin', '2021-07-08 19:50:38', 1413102813927575553, 1413103226995216384);
