			...
			<view class="uni-calendar__box">
				...
				<view class="uni-calendar__weeks" v-for="(item,weekIndex) in weeks" :key="weekIndex">
					<view class="uni-calendar__weeks-item" v-for="(weeks,weeksIndex) in item" :key="weeksIndex">
						<oa-calendar-item :weeks="weeks" :calendar="calendar" :selected="selected" :lunar="lunar" @change="choiceDate"></oa-calendar-item>
					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	import oaCalendarItem from './oa-calendar-item'
	export default {
		components: {
			oaCalendarItem
		},
