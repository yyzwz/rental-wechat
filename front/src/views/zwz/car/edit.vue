    ...
    <Card>
      ...
      <div style="width: 500px">
        <Form ref="form" :model="form" :rules="formValidate" :label-width="100" label-position="left">
              <FormItem label="车辆名称" prop="title" >
                <Input v-model="form.title" clearable/>
              </FormItem>
              <FormItem label="车辆所属人" prop="userName" >
                <Input v-model="form.userName" clearable/>
              </FormItem>
              <FormItem label="牌照" prop="license" >
                <Input v-model="form.license" clearable/>
              </FormItem>
              <FormItem label="行驶证" prop="drivingLicense" >
                <Input v-model="form.drivingLicense" clearable/>
              </FormItem>
...
import { editCarArchives } from "./api.js";
export default {
  name: "edit",
  components: {
  },
    ...
    handleSubmit() {
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          editCarArchives(this.form).then(res => {
